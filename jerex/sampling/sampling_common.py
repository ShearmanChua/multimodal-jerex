...
# def collate_fn_padding(batch, device='cuda'):
...
#             padded_batch[key] = torch.stack(samples).to(device)
#         else:
#             padded_batch[key] = util.padded_stack([s[key] for s in batch]).to(device)
